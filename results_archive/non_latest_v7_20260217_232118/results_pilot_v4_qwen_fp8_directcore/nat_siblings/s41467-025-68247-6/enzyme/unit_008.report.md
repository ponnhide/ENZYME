...
## Issues
- `SCHEMA_INVALID` (error): [{'key': 'dose', 'value': 'low'}] is not of type 'object' at /protocol/steps/0/annotations
- `SCHEMA_INVALID` (error): [{'key': 'dose', 'value': 'low'}] is not of type 'object' at /protocol/steps/1/annotations
- `SCHEMA_INVALID` (error): [{'key': 'dose', 'value': 'low'}] is not of type 'object' at /protocol/steps/2/annotations
