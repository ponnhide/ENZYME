...
- `MISSING_REQUIRED_PROGRAM_KEY` (error): Missing required program key 'profile_name' for device_kind 'thermocycler'. at /protocol/steps/s27/params/program
- `STEP_ID_NOT_FOUND` (error): Edge references missing step: {'from': 's29', 'to': 's30'} at /protocol/edges
