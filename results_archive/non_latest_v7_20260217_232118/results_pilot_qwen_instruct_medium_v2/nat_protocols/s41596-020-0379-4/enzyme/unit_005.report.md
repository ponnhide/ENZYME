...
## Issues
- `SCHEMA_INVALID` (error): 'resuspend' is not one of ['allocate', 'transfer', 'manipulate', 'run_device', 'observe', 'annotate', 'dispose'] at /protocol/steps/2/op
- `UNKNOWN_CORE_OP` (error): Unknown core op: resuspend at /protocol/steps/s3/op
