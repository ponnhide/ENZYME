...
- `UNKNOWN_OBSERVATION_FEATURE` (warn): Unknown registry value: GFP+ cell migration at /protocol/steps/s9/params/features/GFP+ cell migration
- `UNIT_PARSE_ERROR` (error): Invalid unit: organism at /protocol/steps/1/params/amount/unit
- `UNIT_PARSE_ERROR` (error): Invalid unit: organism at /protocol/steps/2/params/amount/unit
